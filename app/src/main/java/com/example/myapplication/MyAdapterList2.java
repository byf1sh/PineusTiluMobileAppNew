...
public class MyAdapterList2 extends RecyclerView.Adapter<MyViewHolderList2> {

    private Context context;
    private List<DataClass> dataList;


    public MyAdapterList2(Context context, List<DataClass> dataList) {
    ...
    @NonNull
    @Override
    public MyViewHolderList2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.available_deck_list,parent,false);

        return new MyViewHolderList2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolderList2 holder, int position) {
        ...
        holder.picImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView tanggal = ((BookingPageList2Activity) context).findViewById(R.id.tanggal);
                TextView name = ((BookingPageList2Activity) context).findViewById(R.id.NameUser);
                TextView rangetanggal = ((BookingPageList2Activity)context).findViewById(R.id.rangetanggal);
...
class MyViewHolderList2 extends RecyclerView.ViewHolder{
    ...
    public MyViewHolderList2(@NonNull View itemView) {
        super(itemView);
