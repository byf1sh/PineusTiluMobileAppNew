...
public class BookingPageListActivity extends AppCompatActivity {
    ...
    //myadapter
    MyAdapterList1 adapter1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //activity
        setContentView(R.layout.activity_booking_page_list);
        //recycler view
        recyclerViewList = findViewById(R.id.view_decklist);
        ...
        //Activity
        LinearLayoutManager linearLayoutManager1 = new LinearLayoutManager(BookingPageListActivity.this,LinearLayoutManager.VERTICAL,false);
        recyclerViewList.setLayoutManager(linearLayoutManager1);

        dataList1 = new ArrayList<>();
        adapter1 = new MyAdapterList1(BookingPageListActivity.this,dataList1);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.settings:
                        ...
                        return true;
                    case R.id.faq:
                        Intent intent1 = new Intent(BookingPageListActivity.this, FAQActivity.class);
                        startActivity(intent1);
                        // Aksi untuk menu item 2
                        return true;
                    case R.id.tutorial:
                        Intent intent2 = new Intent(BookingPageListActivity.this, BookingDateTutorialActivity.class);
