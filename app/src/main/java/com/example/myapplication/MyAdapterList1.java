...
public class MyAdapterList1 extends RecyclerView.Adapter<MyViewHolderList1> {

    private Context context;
    private List<DataClass> dataList;


    public MyAdapterList1(Context context, List<DataClass> dataList) {
    ...
    @NonNull
    @Override
    public MyViewHolderList1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.available_deck_list,parent,false);

        return new MyViewHolderList1(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolderList1 holder, int position) {
        ...
        holder.picImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView tanggal = ((BookingPageListActivity) context).findViewById(R.id.tanggal);
                TextView name = ((BookingPageListActivity) context).findViewById(R.id.NameUser);
                TextView rangetanggal = ((BookingPageListActivity)context).findViewById(R.id.rangetanggal);
                ...
                //pineustilu
                String additionalText = " Pineustilu1";
                String title = dataTitle + additionalText;

                Intent intent = new Intent(context, DetailBookingDeckActivity.class);
                String fasilities = context.getResources().getString(R.string.DetailFasilitasPt1);
                String fasilitiesText = context.getResources().getString(R.string.des_pineustilu1);
...
class MyViewHolderList1 extends RecyclerView.ViewHolder{
    ...
    public MyViewHolderList1(@NonNull View itemView) {
        super(itemView);
