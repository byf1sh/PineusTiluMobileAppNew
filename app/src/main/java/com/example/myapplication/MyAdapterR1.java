...
public class MyAdapterR1 extends RecyclerView.Adapter<MyViewHolderR1> {
    ...
    public MyAdapterR1(Context context, List<DataClass> dataList) {
    ...
    @NonNull
    @Override
    public MyViewHolderR1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_home_item,parent,false);

        return new MyViewHolderR1(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolderR1 holder, int position) {
        ...
        if (value.equals("Tersedia")) {
            ...
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            DatabaseReference dataRef = database.getReference("Harga/Pineustilu1/highseason");
...
class MyViewHolderR1 extends RecyclerView.ViewHolder{
    ...
    public MyViewHolderR1(@NonNull View itemView) {
        super(itemView);
